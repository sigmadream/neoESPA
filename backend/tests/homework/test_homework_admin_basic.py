...
def test_admin_can_create_homework_with_schedule(
...
def test_admin_can_update_testcase_policy(
    client: TestClient,
    session: Session,
    create_user,
    login_user,
...
def test_admin_can_delete_homework_without_submissions(
    client: TestClient,
    session: Session,
    create_user,
    login_user,
    ...
    del_res = client.delete(
        f"/api/admin/homeworks/{homework_num}", headers=auth_headers(token)
    )
...
def test_delete_homework_preserves_submission_protection(
    client: TestClient, create_user, login_user, auth_headers, dt_string
):
...
def test_admin_cannot_update_or_delete_missing_homework(
    client: TestClient, create_user, login_user, auth_headers, dt_string
):
