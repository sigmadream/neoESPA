...
def record_capacity_baseline(
    *, expected_students: int, max_concurrent_submissions: int,
    expected_term_submissions: int, root: Path | None = None,
) -> dict:
    if min(expected_students, max_concurrent_submissions, expected_term_submissions) < 1:
