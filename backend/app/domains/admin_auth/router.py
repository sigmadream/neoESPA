...
def bootstrap_first_admin(
    ...
    try:
        ...
        session.rollback()
        raise HTTPException(
            status_code=409, detail="Admin identity already exists"
        ) from error


@router.post(
    "/invitations", response_model=AdminInvitationIssued, status_code=201
)
def create_admin_invitation(
    ...
    try:
        ...
        observability_service.record_audit(
            ...
            action_type="issue_admin_invitation",
