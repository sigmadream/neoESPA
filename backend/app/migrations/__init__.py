...
from .v0002_submission_adjustments import (
    VERSION as V0002_SUBMISSION_ADJUSTMENTS,
)
from .v0002_submission_adjustments import (
    upgrade as upgrade_v0002_submission_adjustments,
)
from .v0003_platform_extensions import VERSION as V0003_PLATFORM_EXTENSIONS
from .v0003_platform_extensions import (
    upgrade as upgrade_v0003_platform_extensions,
)
from .v0004_user_timestamp_backfill import (
    VERSION as V0004_USER_TIMESTAMP_BACKFILL,
)
from .v0004_user_timestamp_backfill import (
    upgrade as upgrade_v0004_user_timestamp_backfill,
)
from .v0005_materials_board_and_qa import (
    VERSION as V0005_MATERIALS_BOARD_AND_QA,
)
from .v0005_materials_board_and_qa import (
    upgrade as upgrade_v0005_materials_board_and_qa,
)
...
from .v0013_selected_grading_run import (
    upgrade as upgrade_v0013_selected_grading_run,
)
...
from .v0016_admin_auth_assurance import (
    upgrade as upgrade_v0016_admin_auth_assurance,
)
from .v0017_revision_judge_policy import VERSION as V0017_REVISION_JUDGE_POLICY
from .v0017_revision_judge_policy import (
    upgrade as upgrade_v0017_revision_judge_policy,
)
from .v0018_legacy_storage_backfill import (
    VERSION as V0018_LEGACY_STORAGE_BACKFILL,
)
from .v0018_legacy_storage_backfill import (
    upgrade as upgrade_v0018_legacy_storage_backfill,
)
from .v0019_revision_approvals import VERSION as V0019_REVISION_APPROVALS
from .v0019_revision_approvals import (
    upgrade as upgrade_v0019_revision_approvals,
)
...
from .v0021_contest_operation_approvals import (
    VERSION as V0021_CONTEST_OPERATION_APPROVALS,
)
from .v0021_contest_operation_approvals import (
    upgrade as upgrade_v0021_contest_operation_approvals,
)
from .v0022_system_setting_history import (
    VERSION as V0022_SYSTEM_SETTING_HISTORY,
)
from .v0022_system_setting_history import (
    upgrade as upgrade_v0022_system_setting_history,
)
from .v0023_operational_capabilities import (
    VERSION as V0023_OPERATIONAL_CAPABILITIES,
)
from .v0023_operational_capabilities import (
    upgrade as upgrade_v0023_operational_capabilities,
)
from .v0024_interactive_problem_mode import (
    VERSION as V0024_INTERACTIVE_PROBLEM_MODE,
)
from .v0024_interactive_problem_mode import (
    upgrade as upgrade_v0024_interactive_problem_mode,
)
...
MIGRATIONS = [
    ...
    (
        V0021_CONTEST_OPERATION_APPROVALS,
        upgrade_v0021_contest_operation_approvals,
    ),
