...
class Settings:
    ...
    def HOST_CODE_EXECUTION_ALLOWED(self) -> bool:
        ...
        return self.ENVIRONMENT in {"development", "test"} and self.AUTO_GRADING_ENABLED
    ...
    def SANDBOX_READY(self) -> bool:
        ...
        return (
            ...
            >= {"basic", "network", "root_write", "fork_bomb", "timeout", "output"}
    ...
    def COURSE_BUNDLE_ROOT(self) -> Path:
        ...
        if configured:
            ...
            if not root.is_absolute():
                raise RuntimeError("COURSE_BUNDLE_ROOT must be an absolute path")
            return root.resolve()
